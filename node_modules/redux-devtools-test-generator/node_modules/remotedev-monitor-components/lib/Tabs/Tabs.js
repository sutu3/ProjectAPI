...
var Tabs = function (_Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function updateTabs(props) {
      ...
      var tabs = props.tabs;
      var selected = props.selected || tabs[0].name;

      this.tabsHeader = tabs.map(function (tab) {
        var isSelected = void 0;
        if (tab.name === selected) {
          isSelected = true;
          _this2.SelectedComponent = tab.component;
          if (tab.selector) _this2.selector = tab.selector(tab);
        }
    ...
    value: function render() {
      return _react2.default.createElement(
        _styles.TabsContainer,
        { compact: this.props.compact },
        _react2.default.createElement(_TabsHeader2.default, { tabs: this.tabsHeader, buttons: this.props.buttons }),
        _react2.default.createElement(
          'div',
          null,
          this.SelectedComponent && _react2.default.createElement(this.SelectedComponent, this.selector)
        )
      );
    }
  }]);
